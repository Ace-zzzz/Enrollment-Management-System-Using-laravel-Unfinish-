				...
				<div class="order">
					...
					<table>
						...
						@foreach ($student as $student)
                            <tr>
                                ...
                                <td>
                                    <div class='button-container'>
                                        <form action="{{route('confirmEnrollees', ['student' => $student])}}" method = "POST">
											@csrf
											@method('put')
                                            <button class='grades-button'> Confirm </button>
										</form>
							...
							@endforeach
							<!-- Repeat this row structure for each new enrollee -->
						</tbody>
					</table>
				</div>				
			</div>
